    ...
    <div className="dashboard-container dark-theme">
      ...
      <aside className={`dashboard-sidebar ${sidebarCollapsed ? 'collapsed' : ''}`}>
        ...
        <nav className="sidebar-nav">
          ...
          <Link to="/mylistings" className="nav-item" onClick={toggleSidebar}>
            <span className="nav-icon"><Icons.Search /></span>
            <span>My Listings</span>
          </Link>
          <Link to="/favorites?tab=appointments" className={`nav-item ${activeTab === 'appointments' ? 'active' : ''}`} onClick={() => { setActiveTab('appointments'); if (!sidebarCollapsed) toggleSidebar(); }}>
            <span className="nav-icon"><Icons.Calendar /></span>
            <span>Appointment History</span>
          </Link>
          <Link to="/favorites?tab=saved" className={`nav-item ${activeTab === 'saved' ? 'active' : ''}`} onClick={() => { setActiveTab('saved'); if (!sidebarCollapsed) toggleSidebar(); }}>
